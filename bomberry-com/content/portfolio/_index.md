...
media_path = "./assets"
  ...
  [[sections.project]]
    ...
    section = ""
    heading = "Streamlio"
    text = "Streamlio is a Palo Alto startup that provides unified solutions for real-time streaming applications and services that are easy to build, adapt, and scale reliably. They contacted me to refresh their logo, build out their branding guidelines, and to design and develop their web site.<br /><br />I provided consulting and design direction, as well as creating collateral templates, media assets, how-to documents, and modular HUGO/SASS blocks allowing them to compose their own layouts moving forward.<br /><br />In the process I also learned about HuGo, a static web site generation tool, which I currently use in my web development projects."
    asset_path = "streamlio"
    image = "Streamlio-BC-Rendering-PlexusUV.png"
    caption = "Rendered comp"
    media = ["Streamlio-BC-Rendering-PlexusUV.png"]
  ...
  [[sections.project]]
    ...
    text = "I worked with Adobe to develop the 3D portal of Photoshop.com, including creating images, text/copy, and layout comps. In addition I created most of the downloadable content including additional Photoshop materials, sets of Image Based Lights (IBLs), and sets of Stages &amp; Sets as a starting point for the growing Photoshop 3D users."
  ...
  [[sections.project]]
    ...
    text = "I developed more than 150 materials for Photoshop CS3, ranging from several categories from woods and metals to gemstones and synthetic materials. All materials are composed of Photoshop files with several layers that allow for real-time customization."
